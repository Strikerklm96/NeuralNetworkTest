...
std::vector<std::vector<Pixel>> read_training_images() {
    return read_mnist_image_file(filePath + "train-images-idx3-ubyte");
}
...
std::vector<std::vector<Pixel>> read_test_images() {
    return read_mnist_image_file<Pixel, Label>(filePath + "t10k-images-idx3-ubyte");
}
...
std::vector<Label> read_training_labels() {
    return read_mnist_label_file(filePath + "train-labels-idx1-ubyte");
}
...
std::vector<Label> read_test_labels() {
    return read_mnist_label_file(filePath + "t10k-labels-idx1-ubyte");
}
